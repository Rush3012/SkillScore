...
//         testEvent = new Event(); // default constructor
...
class EventServiceTest {
    ...
    void setUp() {
        ...
        testEvent = new Event(); // Using default constructor
        // Set all properties
        testEvent.setName("Tech Fest");
        testEvent.setDescription("Annual technical festival");
        testEvent.setPoints(50);
        ...
        // <-- Set the ID so that the test can assert against it.
        testEvent.setId(1L);
    }
    ...
    void saveEvent_ReturnsSavedEvent() {
        ...
        Event savedEvent = eventService.saveEvent(testEvent);
        assertNotNull(savedEvent);
        // This should now return 1 as we set the ID above.
        assertEquals(1L, savedEvent.getId());
    }
